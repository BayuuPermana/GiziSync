...
## 2025-12-15 - Icon-Only Button Accessibility
**Learning:** Icon-only buttons (like Edit/Delete) are common but often lack accessibility for screen readers.
**Action:** Always add `aria-label` to buttons that only contain an icon, describing the action and the context (e.g., "Edit [Item Name]").
