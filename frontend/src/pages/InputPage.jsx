    ...
    <div className="min-h-screen bg-slate-50">
      <header className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between sticky top-0 z-10">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" onClick={() => navigate('/')} aria-label="Kembali ke Beranda">
          ...
          <CardContent className="pt-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="p-4 bg-slate-50 rounded-xl border border-slate-200">
                ...
                <div className="flex items-center gap-4">
                  <input type="file" className="peer sr-only" id="file-upload" />
                  <Label htmlFor="file-upload" className="peer-focus-visible:ring-2 peer-focus-visible:ring-indigo-500 peer-focus-visible:border-indigo-500 cursor-pointer flex items-center justify-center w-full h-32 border-2 border-dashed border-slate-300 rounded-lg hover:bg-white hover:border-indigo-400 transition-all">
