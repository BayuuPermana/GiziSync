            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="p-4 bg-slate-50 rounded-xl border border-slate-200">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Label htmlFor="file-upload" className="peer-focus-visible:ring-2 peer-focus-visible:ring-indigo-500 peer-focus-visible:ring-offset-2 cursor-pointer flex items-center justify-center w-full h-32 border-2 border-dashed border-slate-300 rounded-lg hover:bg-white hover:border-indigo-400 transition-all">
